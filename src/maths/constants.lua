...
local NEPS = 1e-13 -- NEPS is derived from a series of tests to determine the optimal precision
...
local TAU = math.pi * 2
return { EPS = EPS, NEPS = NEPS, TAU = TAU, spatialResolution = spatialResolution }
