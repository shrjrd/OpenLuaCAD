...
test("expandgeom3. expand completes properly, issue 876", function(done)
	return Promise.resolve():andThen(function()
		setTimeout(function()
			return error(Error.new("expandgeom3 did not complete")) --done:fail()
		end, 1000)
		local polies = {
			poly3.create({
